DROP DATABASE IF EXISTS Geld_her;
...
(
  ...
  Kunde_ID INT NOT NULL,  -- Corrected column name
  Datum DATE NOT NULL,
...
(
  Spedition_ID INT AUTO_INCREMENT,
...
(
  ...
  Euro_Preis DECIMAL(11,2) NOT NULL,
...
(
  ...
  FOREIGN KEY (Abrechnung_ID) REFERENCES Abrechnung(Abrechnung_ID) ON DELETE CASCADE ON UPDATE RESTRICT,
  FOREIGN KEY (Produkt_ID) REFERENCES Produkt(Produkt_ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
